...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="bg-gradient-to-r from-green-600 to-green-400 text-white text-center py-20">
        <h2 class="text-4xl md:text-5xl font-extrabold text-slate-800 dark:text-slate-50 mb-4">Power Your Life, Off The Grid</h2>
    ...
    <section id="products" class="max-w-6xl mx-auto px-6 py-16">
        <h3 class="text-3xl font-bold text-slate-800 dark:text-slate-50 text-center mb-10">Featured Products</h3>
        
        <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 ">
            <asp:Repeater ID="waterSection" runat="server">
                <ItemTemplate>
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:scale-105 transition-transform bg-slate-50 dark:bg-gray-800">
                        <a href='About.aspx?prodID=<%# Eval("Product_ID") %>'>
                            <img src='<%# Eval("Product_Image") %>' alt="" class="w-full h-48 object-cover">
                            <div class="p-5">
                                <h4 class="text-lg font-semibold text-gray-700 mb-2 dark:text-slate-50">
                                    <%# Eval("Product_Name") %>
                                </h4>
